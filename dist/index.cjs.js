...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 640 701.07" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("style", null, ".cls-1{fill:#070707;}.cls-2{fill:#2e2e2e;}.cls-3{fill:#fff;opacity:0.05;}.cls-4{fill:url(#linear-gradient);}.cls-5{fill:url(#linear-gradient-2);}.cls-6{fill:url(#linear-gradient-3);}.cls-7{fill:url(#linear-gradient-4);}"),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient", x1: "117.3", y1: "452.72", x2: "595.64", y2: "126.99", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { offset: "0", stopColor: "#00e1ff" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#007aff" })),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient-2", x1: "155.53", y1: "508.85", x2: "633.86", y2: "183.12" }),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient-3", x1: "109.05", y1: "440.6", x2: "587.38", y2: "114.87" }),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient-4", x1: "174.09", y1: "536.11", x2: "652.42", y2: "210.38" })),
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 1734.33 453.72" }, props),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("style", null, ".cls-1{isolation:isolate;}.cls-2{opacity:0.2;mix-blend-mode:multiply;}.cls-3{fill:" + textColor + ";}.cls-4{fill:#24b2fa;}.cls-5{fill:#2e2e2e;}.cls-6{fill:#fff;opacity:0.05;}.cls-7{fill:url(#linear-gradient);}.cls-8{fill:url(#linear-gradient-2);}.cls-9{fill:url(#linear-gradient-3);}.cls-10{fill:url(#linear-gradient-4);}"),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient", x1: "81.58", y1: "289.8", x2: "374.89", y2: "90.06", gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { offset: "0", stopColor: "#00e1ff" }),
                React__default['default'].createElement("stop", { offset: "1", stopColor: "#007aff" })),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient-2", x1: "105.02", y1: "324.22", x2: "398.33", y2: "124.48", xlinkHref: "#linear-gradient" }),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient-3", x1: "76.52", y1: "282.37", x2: "369.83", y2: "82.63", xlinkHref: "#linear-gradient" }),
            React__default['default'].createElement("linearGradient", { id: "linear-gradient-4", x1: "116.41", y1: "340.94", x2: "409.72", y2: "141.2", xlinkHref: "#linear-gradient" })),
        React__default['default'].createElement("title", null, "lionfinance"),
